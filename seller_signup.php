      ...
      <div class="row">
        <div class="col text-center mt-1">
          <a href="index" class="ec-header-btn ec-header-user m-2">
            <div class="header-icon"><img src="assets/images/logo/ONLY LOGO2.png" class="svg_img header_svg" alt="logo" style="width: 100px; height: 100px;" /></div>
          </a>
          <h4 class="fw-bold">Sell photos, vectors & PSD designs on PikMingle</h4>
          <p>Become a Freepik contributor and make money selling your images and designs online.</p>
        </div>
      </div>
    </div>
  </header>
        ...
        <div class="col-sm-4">
          <div class="card text-start p-2" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  <h4 class="card-title fw-bold my-3">Create an account</h4>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="email" name="" id="" class="form-control" placeholder="pikmingle@gmail.com">
              </div>
              <div class="mb-3">
              ...
              <div class="col-auto">
                <button type="submit" class="btn text-light mb-3 w-100  fw-bold" style="box-shadow: rgba(0, 0, 0, 0.35) 0px -50px 36px -28px inset; background:#dc3545; border-radius:8px;">Sign up</button>
              </div>
              <!-- google login -->
              ...
              <p class="sub-title mb-3"><span class="text-center">Already have an account?<a href="seller_login" class="text-info setup-password" style="color: #3474d4; text-decoration: none;"> Log In</a></span></p>
            </div>
          </div>
        </div>
      </div>
