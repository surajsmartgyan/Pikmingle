          ...
          <div class="card text-start p-2" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <input type="email" name="npass" id="npass" class="form-control" placeholder="******" required>
              </div>
              <div class="mb-3">
                <label for="" class="form-label">Confirm password</label>
                <input type="email" name="cpass" id="cpass" class="form-control" placeholder="******" required>
              </div>
              <div class="col-auto">
                <button type="submit" class="btn text-light mb-3 w-100 fw-bold" style="box-shadow: rgba(0, 0, 0, 0.35) 0px -50px 36px -28px inset; background-color: #d51c3f; border-radius:8px;">Set New Password</button>
              </div>
            </div>
          </div>
        </div>
