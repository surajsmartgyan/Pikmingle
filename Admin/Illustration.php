...
style="margin-left: 820px;padding: 10px 30px; width: 200px;" data-toggle="modal"
data-target="#small-Modal">Add Illustration</button>
<div class="modal fade" id="small-Modal" tabindex="-1" role="dialog">
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Add Illustration</h4>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success waves-effect"
                id="saveAsset">Save Illustration</button>
        </div>
    </div>
</div>
</div>
