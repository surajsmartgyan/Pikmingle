                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        ...
                                        <button type="button" class="btn btn-success waves-effect btn-align"
                                            ...
                                            style="margin-left:870px;padding: 10px 30px;">add new offer</button>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close"  style="padding-top: 25px; padding-bottom: 15px;">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="offerType" value="Free" id="freeType">
                                                                    <label class="form-check-label"
                                                                        for="freeType">Free</label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        name="offerType" value="Premium"
                                                                        id="premiumType">
                                                                    <label class="form-check-label"
